    ...
    private static void generateApplicationContextName(final int name,
        ...
        if (!settings.isServer()
            ...
            if (cipher.getSystemTitle() == null || cipher.getSystemTitle().length == 0) {
                // System title was not provided; using default 8-byte zero system title to continue.
                // The source system title can be set in settings if a specific value is required.
            }
